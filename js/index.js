...
var verbs = ["eater", "walker", "runner", "crawler", "heart", "head", "soul", "blaze", "wing", "pool", "puffle", "tuffle", "bottom", "top", "son", "claw", "mark", "person", "watcher", "face", "trance", "quiver", "whisper", "hands", "thorn", "mist", "moon", "flare", "leg", "bounce", "fang", "fern", "sould", "trumper", "eclipse", "jazzer", "priester", "gaze", "berger", "burger", "cheese", "belly", "slayer", "hawk", "paw", "nugget", "spirit", "dreamer", "slush", "spark", "glow", "stripe", "speed", "board"];
